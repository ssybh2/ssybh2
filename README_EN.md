...
<!--
Dynamic contribution artwork is generated by:
- .github/workflows/breakout.yml -> images/breakout-light.svg / images/breakout-dark.svg
- .github/workflows/profile-3d.yml -> profile-3d-contrib/*.svg
Once the first workflow run completes, these can be surfaced here without changing the main visual style.
-->